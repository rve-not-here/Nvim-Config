...
map("n", "<leader>xx", function() Snacks.picker.diagnostics() end, { desc = "Diagnostics list" })
map("n", "<leader>xX", function() Snacks.picker.diagnostics_buffer() end, { desc = "Buffer diagnostics" })
map("n", "<leader>xl", function() Snacks.picker.loclist() end, { desc = "Location list" })
map("n", "<leader>xq", function() Snacks.picker.qflist() end, { desc = "Quickfix list" })
...
map("n", "gm", function() Snacks.picker.marks() end, { desc = "Marks" })
map("n", "<leader>da", function() Snacks.picker.diagnostics() end, { desc = "Diagnostics" })
...
map("n", "<leader>i", function() Snacks.picker.lsp_implementations() end, { desc = "Implementations" })
map("n", "T", function() Snacks.picker.buffers() end, { desc = "Buffers" })
map("n", "<leader>fo", function() Snacks.picker.recent() end, { desc = "Old files" })
map("n", "<leader>qo", function() Snacks.picker.qflist() end, { desc = "Quickfix" })
map("n", "<leader>qO", function() Snacks.picker.grep({ need_search = true }) end, { desc = "Grep" })
map("n", "<leader>?", function() Snacks.picker.pickers() end, { desc = "Pickers" })
