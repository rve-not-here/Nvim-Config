...
vim.api.nvim_create_user_command("RoslynDebug", function()
  ...
  vim.notify(
    "roslyn_ls: snippetSupport="
      .. vim.inspect(snippet_advertised)
      .. " triggerChars="
      .. vim.inspect(server_caps.completionProvider and server_caps.completionProvider.triggerCharacters)
      .. " resolveProvider="
      .. vim.inspect(server_caps.completionProvider and server_caps.completionProvider.resolveProvider)
      .. " clients(bufnr 0)="
